...
<body>
    ...
    <a href="/lesson_2/home_work/admin/add.php"><p style="text-align: center;">Добавить новость</p></a><br>
    <?php
    foreach ($this->data['Articles'] as $article) { ?>
        ...
        <a href="/lesson_2/home_work/admin/update.php?id=<?php echo $article->id; ?>">
            <p style="text-align: center;">Обновить новость</p></a><br>
        <a href="/lesson_2/home_work/admin/active/delete.php?id=<?php echo $article->id; ?>">
            <p style="text-align: center;">Удалить новость</p></a><br>
        <?php
    }
    ?>
    <a href="/lesson_2/home_work/index.php"><p style="text-align: center;">Назад на главную</p></a>
</body>
</html>
